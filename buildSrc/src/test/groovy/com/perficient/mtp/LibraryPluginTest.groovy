...
class LibraryPluginTest extends PluginTest {
    ...
    def "publishes library with versionin"() {
        ...
        testProjectDir.newFile('src/main/java/com/perficient/mtp/Util.java') << """
            package com.perficient.mtp;
        ...
        new File(testProjectDir.getRoot(), 'build/test-repo/com/perficient/mtp/my-library/0.1.0/my-library-0.1.0.jar').exists()
    }
